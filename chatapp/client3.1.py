import threading, time, socket,os,struct,requests
#服务器公网ip地址
host ="81.70.245.218"
port = 8888
addr0 = (host, port)
...
def clinet_receive_file(skt):
    ...
    #this_ip=requests.get('https://checkip.amazonaws.com').text.strip()
    #this_ip="111.20.225.141"
    #this_ip="10.172.58.53"
    this_ip="103.46.128.49"
    print("您的ip地址是 "+this_ip)
    #sendmsg(skt,this_ip+"$6666","sendhere$")
    sendmsg(skt, this_ip + "$40780", "sendhere$")
    print("等待连接...")
